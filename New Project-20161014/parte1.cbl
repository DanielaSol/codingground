      ...
      *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
       ...
       01 LINEA-TOTAL-FECHA.
          ...
          03 FILLER PIC X(5) VALUE SPACES.
          03 MOTRAR-TOTAL-IMPORTE-FECHA PIC ZZZZZZ9.99.
       01 LINEA-TOTAL-PROFESOR.
           03 FILLER PIC X(21) VALUE 'TOTALES POR PROFESOR:'.
           03 FILLER PIC X(36) VALUE SPACES.
           03 MOSTRAR-TOTAL-HORAS-PROFESOR PIC ZZZZ.99.
           03 FILLER PIC X(1) VALUE ' '.
           03 MOSTRAR-TOTAL-IMPORTE-PROFESOR PIC ZZZZZZZZ.99.
       01 LINEA-TOTAL-GRAL.
